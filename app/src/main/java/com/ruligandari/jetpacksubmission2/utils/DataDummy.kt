package com.ruligandari.jetpacksubmission2.utils
...
object DataDummy {
    ...
    fun generateRemoteDummyTvshow(): List<TvShowsResponse> {

        val tvShow = ArrayList<TvShowsResponse>()

        tvShow.add(TvShowsResponse(
            88396,
            "https://image.tmdb.org/t/p/original/kbAMLteGO8yyewYau6bJ683sw7.jpg",
            "The Falcon and the Winter Soldier",
            "2021-03-19",
